            ...
            <div className="md:w-1/2 grid grid-cols-2 gap-4">
              <ScrollReveal>
                <div className="group relative rounded-lg overflow-hidden">
                  <img 
                    src="https://images.unsplash.com/photo-1531482615713-2afd69097998?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" 
              ...
              <ScrollReveal>
                <div className="group relative rounded-lg overflow-hidden mt-8">
                  <img 
                    src="https://images.unsplash.com/photo-1524178232363-1fb2b075b655?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" 
              ...
              <ScrollReveal>
                <div className="group relative rounded-lg overflow-hidden mt-8">
                  <img 
                    src="https://images.unsplash.com/photo-1517048676732-d65bc937f952?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" 
                    alt="Team meeting" 
                    className="rounded-lg h-64 object-cover w-full transition-transform duration-700 group-hover:scale-110"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-background/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
